...
urls = ['http://economictimes.indiatimes.com/news/science']
hdr = {'User-Agent':'Mozilla/5.0','Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'}
for i in range(2,100):
	urls.append('http://economictimes.indiatimes.com/news/science/' + str(i))

columns = ['Heading', 'Link', 'Summary','Date']
csv_file=open('Eco_Science[Dec16].csv', 'w')
